from VIGENERE import hackVigenere
...
class Cipher:
    def __init__(self,master):
        ...
        label.pack(padx=10)
        self.ebutton = tk.Button(iframe,text="Decrypt",command=self.dec,font="Arial 15")
        ...
        label = tk.Label(eframe,text="Plain text",font="Times 20 bold")
        label.pack(padx=10)
...
if __name__ == "__main__":
    window = tk.Tk()
    window.title("Kasiski decryption")
