...
class Start:
    def __init__(self,master):
        ...
        self.a = tk.Text(self.frame,height=1,width=25,font="Times 15")
        ...
        self.b = tk.Text(self.frame,height=1,width=25,font="Times 15")
...
class Cipher:
    def __init__(self,master,obj):
        ...
        self.text = tk.Text(self.frame,height=40,width=60,fg="black",font="Times 15")
        ...
        self.etext = tk.Text(self.frame,height=40,width=60,fg="black",font="Times 15")
